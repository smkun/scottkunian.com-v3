export function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-r from-primary/20 via-accent/10 to-secondary/20 backdrop-blur-md border-t border-primary/20 shadow-[0_-4px_20px_rgba(168,85,247,0.3)] mt-auto">
          ...
          <div className="flex items-center space-x-4 order-2 md:order-3">
            {socialLinks.map((link) => (
              <a
                ...
                className="text-foreground hover:text-primary transition-all duration-300 p-2 rounded-full hover:bg-gradient-to-r hover:from-primary/30 hover:via-accent/30 hover:to-secondary/30 hover:scale-110 hover:shadow-lg hover:shadow-primary/20"
